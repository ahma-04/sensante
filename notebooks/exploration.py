...
csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "data", "patients_dakar.csv")
if not os.path.exists(csv_path):
    # Si on exécute depuis notebooks (cas de l’erreur), on essaie le même fichier via data locale
    csv_path = os.path.abspath(os.path.join("..", "data", "patients_dakar.csv"))
